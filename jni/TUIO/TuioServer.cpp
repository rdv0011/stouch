...
const char* TUIOServerTag = "TUIOServer";
#define  LOGD(x...)  __android_log_print(ANDROID_LOG_INFO,TUIOServerTag,x)
#define  LOGE(x...)  __android_log_print(ANDROID_LOG_ERROR,TUIOServerTag,x)
#else
#define  LOGD(x...)  std::cout << x;
#define  LOGE(x...)  std::cout << x;
#endif
